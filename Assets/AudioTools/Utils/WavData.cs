...
//						tbxPlay.Text = waveHeader.PlayTimeMsec.ToString() + "ms秒";
	...
	//
	public WaveHeaderArgs WaveHeader
    {
        get { return waveHeader; }
    }

	public int Channnel
    {
        get { return waveHeader.Channel; }
    }

	public int Datasize
    {
        get { return waveHeader.DataChunkSize; }
    }

	public int TimeMsec
	{
        get { return waveHeader.PlayTimeMsec; }
    }
}
